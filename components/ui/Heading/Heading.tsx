...
const Heading: React.FC<HeadingProps> = ({
  children,
  desc = "Popular places to stay that recommends for you",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {desc && (
          <span className="mt-2 md:mt-3 font-normal block text-sm sm:text-base text-neutral-500 dark:text-neutral-400">
            {desc}
          </span>
        )}
      </div>

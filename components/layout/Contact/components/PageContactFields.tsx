...
const PageContactFields = () => {
  ...
  return (
    <form
      className="lg:w-1/2 pt-6 pb-8 w-full flex flex-col justify-start items-start px-4 sm:px-8  
      rounded-xl bg-[#fafafa] dark:bg-neutral-800 gap-1"
    ...
    >
      ...
      <ButtonPrimary
        className="bg-primary-600 hover:bg-primary-700 font-semibold text-white 
      rounded-lg px-6 py-2 text-base w-full  transition-colors duration-200 ease-in-out"
        type="submit"
